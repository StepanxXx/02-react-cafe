...
Додаток має модульну структуру. Компоненти розташовані у папці `src/components/`, а типи — у `src/types/`:
...
6. **`types`** (`src/types/votes.ts`) — Визначення TypeScript типів (`Votes`, `VoteType`).
